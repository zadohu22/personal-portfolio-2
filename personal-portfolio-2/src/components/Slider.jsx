...
import { SiReact, SiJavascript, SiHtml5, SiCss3, SiTailwindcss, SiFirebase, SiGithub, SiNodedotjs, SiMongodb } from "react-icons/si";

const Slider = () => {
	return (
		<>
			<div className='h-32 bg-transparent text-[#20201F] cursor-default '>
				<Carousel
