...
const About = () => {
  return (
    <div className='w-full h-[60em] md:h-[40em] grid grid-cols-1 px-2 md:grid-cols-2 md:mt-24 lg:px-12'>
      <div className='w-full h-full flex flex-col justify-center items-center px-6 py-20'>
        ...
        <p className='flex-1 text-center mt-8 relative bottom-8 md:bottom-4 md:mb-[8rem] leading-8'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos sequi
          quis deleniti dolores vel? Deleniti incidunt rerum, ipsam consectetur
          quam ratione ducimus cupiditate doloremque? Necessitatibus?
        </p>
      </div>
      ...
      <div className='w-full h-full flex flex-col justify-center items-center md:px-6 md:py-20 '>
        ...
        <div className='flex gap-8 text-center flex-1 mt-20 '>
          <div className='border-r-2  md:border-l-0 border-slate-300 pr-4'>
            <h3 className='underline text-2xl font-bold md:mt-8 '>
              Experienced
            </h3>
