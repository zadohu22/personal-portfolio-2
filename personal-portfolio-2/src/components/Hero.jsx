		...
		<div className="hero h-screen ">
			<div className='hero-content text-center'>
				<div className='max-w-md'>
					...
					<button className='btn max-w-64 h-12 shadow-sm shadow-slate-300 bg-primary border-primary text-slate-800 hover:bg-slate-500 hover:border-primary hover:text-primary'>
						Projects
					</button>
				</div>
			</div>
